...
- **configure** (f) `(source_path, mode="painting", svg_width=1000, palette=None, ..., gap_stroke=None, **overrides)` :75
- **image_to_svg** (f) `(source_path, mode="painting", svg_width=1000, palette=None, ..., **overrides)` :777
